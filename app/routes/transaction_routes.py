    ...
    if request.method == 'POST':
        try:
            ...
            for i in range(parcelas):
                # Se definimos uma parcela inicial (ex: 8 de 10), pulamos as anteriores
                ...
                if parcelas > 1:
                    ...
                    # Ajusta a data: a data informada é a da primeira parcela real (i=0)
                    # Mas se estamos começando da parcela 8, a data informada deve ser a da parcela 8
                    # Então calculamos o deslocamento relativo à parcela inicial
                    offset = i - (parcela_inicial - 1)
                    
                    mes = parcela_data.month + offset
