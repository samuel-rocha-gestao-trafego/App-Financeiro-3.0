...
def create_app(config_name=None):
    ...
    from app.models import (  # noqa: F401
        ...
        CreditCard, CardPurchase, RecurringBill, Budget, Goal, UserSettings
    )
    ...
    # Nota: Em produção (Railway), recomenda-se usar Flask-Migrate 
    # ou rodar a criação de tabelas manualmente/via script de deploy.
